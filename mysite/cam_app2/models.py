...
class ImagePage(Page):
    ...
    def serve(self, request):
        model, function_run = get_model_and_running_func(weights_path=str(os.path.join(settings.WEIGHTS_DIR, 'best.pt')), data_path=str(os.path.join(settings.DATA_DIR, 'new_data_yaml.yaml')))
