        ...
        while True:
            if AI:
                ...
                if len(bbox_counts) == 2:
                    ...
                    bbox_counts = []
                    create_table('data.db', 'detection_level', 'people_count TEXT, crowdedness TEXT, date_time DATETIME')
                    ...
                    if bbox_average is not None:
                        if bbox_average > 20:
                            ...
                            insert_data_to_table('data.db', 'detection_level', f'{str(bbox_average)},{predicted_crowdedness},{str(format_datetime)}')
                        else:
