...
class PreLoadedVideoPage(Page):
    """Preloaded Video Page."""

    template = "preloaded_video/video2.html"
    ...
    def reset_context(self, request):
        ...
        context['bounding_box_count'] = []
        return context

    def serve(self, request):
        return render(request, "preloaded_video/video2.html", {'page': self})
